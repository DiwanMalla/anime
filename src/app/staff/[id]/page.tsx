                ...
                <div className="space-y-4 text-sm">
                  {staff.name.native && (
                    <div>
                      ...
                      <div className="text-foreground">{staff.name.native}</div>
                    </div>
                  )}
                  {staff.gender && (
                    <div>
                      ...
                      <div className="text-foreground">{staff.gender}</div>
                    </div>
                  )}
                  {staff.age && (
                    <div>
                      ...
                      <div className="text-foreground">{staff.age}</div>
                    </div>
                  )}
                  {staff.homeTown && (
                    <div>
                      ...
                      <div className="text-foreground">{staff.homeTown}</div>
                    </div>
                  )}
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-6">
                  {staff.characters.edges.map((edge: any) => (
                    <Link
                      ...
                      className="group space-y-3"
                    >
                      <div className="relative aspect-[2/3] rounded-xl overflow-hidden border border-foreground/10 group-hover:border-[#bc13fe]/50 transition-all">
                        <img
                      ...
                      <div>
                        <div className="text-sm font-bold text-foreground line-clamp-2 group-hover:text-[#bc13fe] transition-colors">
                          {edge.node.name.full}
                        </div>
                      </div>
                    </Link>
