    ...
    <main className="min-h-screen bg-background text-foreground pt-24 pb-20 px-4 md:px-12">
      <div className="max-w-[1800px] mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 relative z-10">
          ...
          <div className="flex items-center gap-2 text-foreground bg-foreground/5 backdrop-blur-md border border-foreground/10 px-4 py-2 rounded-full text-sm font-medium">
        ...
        {/* Date Selector */}
        <div className="sticky top-20 z-40 bg-background/80 backdrop-blur-xl border-y border-foreground/5 -mx-4 md:-mx-12 px-4 md:px-12 py-4 mb-8">
                ...
                return (
                  <button
                    ...
                    className={`flex flex-col items-center justify-center w-16 md:w-24 py-3 rounded-2xl transition-all duration-300 relative group ${
                      isSelected
                        ? "bg-foreground text-background shadow-[0_0_20px_rgba(var(--foreground-rgb),0.3)] scale-105"
                        : "bg-foreground/5 text-foreground/50 hover:bg-foreground/10 hover:text-foreground"
                    }`}
                  >
                    <span
                      className={`text-[10px] md:text-xs font-bold uppercase mb-1 ${
          ...
          {loading ? (
            ...
            >
              {schedule.map((item) => (
                <div
                  key={item.id}
                  className="anime-panel border border-foreground/10 rounded-xl overflow-hidden hover:border-[#bc13fe]/50 transition-all group flex"
                >
                  ...
                  <div className="p-4 flex flex-col justify-center min-w-0">
                    ...
                    <div className="font-bold text-foreground truncate mb-1 group-hover:text-[#bc13fe] transition-colors">
            ...
            >
              <Calendar className="h-16 w-16 text-foreground/20 mb-6" />
