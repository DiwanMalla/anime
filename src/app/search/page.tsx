        ...
        <section>
          ...
          {!loading && search && results.length === 0 && (
            <div className="text-center py-20">
              <p className="text-2xl text-gray-500">No anime found matching your search.</p>
              <p className="text-gray-600 mt-2">Try different keywords or check for typos.</p>
            </div>
          ) : !loading && !search && (
            <div className="text-center py-20 border-2 border-dashed border-gray-800 rounded-3xl">
              ...
              <p className="text-xl text-gray-600 font-medium">Your search results will appear here</p>
            </div>
          )}
        </section>
      </div>
