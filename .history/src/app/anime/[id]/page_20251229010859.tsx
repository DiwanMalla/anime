    ...
    <main className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="relative h-[40vh] md:h-[50vh] w-full">
        <div className="absolute top-4 left-4 z-20">
          <Link
            href="/"
            className="flex items-center gap-2 bg-gray-900/60 backdrop-blur-md text-white px-4 py-2 rounded-full hover:bg-gray-900 transition border border-gray-700"
          >
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-4 mb-6 text-gray-300">
              ...
              <div className="flex items-center gap-1">
                ...
                <span>
                  {anime.episodes} Episodes ({anime.duration}m)
                </span>
              </div>
