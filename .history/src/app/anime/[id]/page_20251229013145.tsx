      ...
      <div className="max-w-[1800px] mx-auto px-4 md:px-12 -mt-48 relative z-10">
        <div className="flex flex-col lg:flex-row gap-12">
                ...
                <div className="flex flex-col gap-3">
                  {anime.externalLinks.map((link: any) => (
                    <a
                      ...
                      className="flex items-center gap-3 text-sm text-gray-300 hover:text-white transition group bg-white/5 p-2 rounded hover:bg-white/10 border border-transparent hover:border-[#00f3ff]/30"
                    >
                      {link.icon ? (
                        <img
                          src={link.icon}
                      ...
                      <span className="font-mono uppercase tracking-wide group-hover:text-[#00f3ff] transition-colors">
                        {link.site}
                      </span>
                    </a>
                  ))}
          ...
          <div className="flex-1 pt-4">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-white via-gray-200 to-gray-500 drop-shadow-[0_0_10px_rgba(255,255,255,0.3)]">
              {title}
            </h1>
